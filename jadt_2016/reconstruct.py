...
def check_sentence(repo, filenames, dwin, data, output_dico, labels):
	...
	print "extraits simples pour le reseau :"
	for i, sentence in zip(range(len(right)), right):
...
if __name__=="__main__":
	...
	check_sentence(repo, filenames, dwin, data, output_dico, labels)
